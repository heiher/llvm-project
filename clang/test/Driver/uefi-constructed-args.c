...
// RUN: %clang -### --target=loongarch64-unknown-uefi -print-search-dirs 2>&1 \
// RUN:     | FileCheck -check-prefixes=LA64-PROGPATH %s
// LA64-PROGPATH: InstalledDir: [[DRIVER_INSTALLED_DIR:.*]]
// LA64-PROGPATH: programs: =[[DRIVER_INSTALLED_DIR]]
