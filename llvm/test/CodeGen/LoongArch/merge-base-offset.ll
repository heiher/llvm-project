...
; LA32-NEXT:    ori $a1, $zero, 1
; LA32-NEXT:    st.w $a1, $a0, %pcadd_lo12(.Lpcadd_hi27+4096)
; LA32-NEXT:    ret
;
...
; LA32-NEXT:    ld.w $a0, $a0, %pcadd_lo12(.Lpcadd_hi31+8)
; LA32-NEXT:    ret
;
...
; LA32-NEXT:    addi.w $a0, $a0, %pcadd_lo12(.Lpcadd_hi32+8)
; LA32-NEXT:    ret
;
...
; LA32-NEXT:    addi.w $a0, $a0, %pcadd_lo12(.Lpcadd_hi33+2056)
; LA32-NEXT:    ret
;
...
; LA32-NEXT:    addi.w $a0, $a0, %pcadd_lo12(.Lpcadd_hi34+8388608)
; LA32-NEXT:    ret
;
...
; LA32-NEXT:    addi.w $a0, $a0, %pcadd_lo12(.Lpcadd_hi35+8388616)
; LA32-NEXT:    ret
;
...
; LA32-NEXT:    addi.w $a0, $a0, %pcadd_lo12(.Lpcadd_hi36+2147463168)
; LA32-NEXT:    ret
;
...
; LA32-NEXT:    addi.w $a0, $a0, %pcadd_lo12(.Lpcadd_hi37+2147463176)
; LA32-NEXT:    ret
;
...
; LA32-NEXT:    addi.w $a0, $a0, %pcadd_lo12(.Lpcadd_hi39+2059194368)
; LA32-NEXT:    ret
;
...
; LA32-NEXT:    addi.w $a0, $a0, %pcadd_lo12(.Lpcadd_hi40+1145062464)
; LA32-NEXT:    ret
;
...
; LA32-NEXT:    addi.w $a0, $a0, %pcadd_lo12(.Lpcadd_hi42+858794664)
; LA32-NEXT:    ret
;
