...
; RUN: llc --mtriple=loongarch32 -mattr=+d,-la32s < %s | FileCheck %s --check-prefixes=ALL,LA32R
; RUN: llc --mtriple=loongarch32 -mattr=+d,+la32s < %s | FileCheck %s --check-prefixes=ALL,LA32S
