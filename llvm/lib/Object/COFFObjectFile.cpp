...
StringRef COFFObjectFile::getRelocationTypeName(uint16_t Type) const {
  ...
  case Triple::loongarch64:
    switch (Type) {
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_NONE);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_32);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_64);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_RELATIVE);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_COPY);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_JUMP_SLOT);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_TLS_DTPMOD32);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_TLS_DTPMOD64);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_TLS_DTPREL32);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_TLS_DTPREL64);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_TLS_TPREL32);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_TLS_TPREL64);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_IRELATIVE);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_MARK_LA);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_MARK_PCREL);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_SOP_PUSH_PCREL);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_SOP_PUSH_ABSOLUTE);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_SOP_PUSH_DUP);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_SOP_PUSH_GPREL);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_SOP_PUSH_TLS_TPREL);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_SOP_PUSH_TLS_GOT);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_SOP_PUSH_TLS_GD);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_SOP_PUSH_PLT_PCREL);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_SOP_ASSERT);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_SOP_NOT);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_SOP_SUB);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_SOP_SL);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_SOP_SR);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_SOP_ADD);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_SOP_AND);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_SOP_IF_ELSE);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_SOP_POP_32_S_10_5);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_SOP_POP_32_U_10_12);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_SOP_POP_32_S_10_12);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_SOP_POP_32_S_10_16);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_SOP_POP_32_S_10_16_S2);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_SOP_POP_32_S_5_20);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_SOP_POP_32_S_0_5_10_16_S2);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_SOP_POP_32_S_0_10_10_16_S2);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_SOP_POP_32_U);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_ADD8);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_ADD16);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_ADD24);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_ADD32);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_ADD64);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_SUB8);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_SUB16);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_SUB24);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_SUB32);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_SUB64);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_GNU_VTINHERIT);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_GNU_VTENTRY);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_B16);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_B21);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_B26);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_ABS_HI20);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_ABS_LO12);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_ABS64_LO20);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_ABS64_HI12);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_PCALA_HI20);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_PCALA_LO12);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_PCALA64_LO20);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_PCALA64_HI12);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_GOT_PC_HI20);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_GOT_PC_LO12);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_GOT64_PC_LO20);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_GOT64_PC_HI12);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_GOT_HI20);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_GOT_LO12);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_GOT64_LO20);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_GOT64_HI12);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_TLS_LE_HI20);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_TLS_LE_LO12);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_TLS_LE64_LO20);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_TLS_LE64_HI12);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_TLS_IE_PC_HI20);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_TLS_IE_PC_LO12);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_TLS_IE64_PC_LO20);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_TLS_IE64_PC_HI12);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_TLS_IE_HI20);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_TLS_IE_LO12);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_TLS_IE64_LO20);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_TLS_IE64_HI12);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_TLS_LD_PC_HI20);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_TLS_LD_HI20);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_TLS_GD_PC_HI20);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_TLS_GD_HI20);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_32_PCREL);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_RELAX);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_ALIGN);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_PCREL20_S2);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_ADD6);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_SUB6);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_ADD_ULEB128);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_SUB_ULEB128);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_64_PCREL);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_CALL36);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_TLS_DESC32);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_TLS_DESC64);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_TLS_DESC_PC_HI20);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_TLS_DESC_PC_LO12);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_TLS_DESC64_PC_LO20);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_TLS_DESC64_PC_HI12);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_TLS_DESC_HI20);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_TLS_DESC_LO12);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_TLS_DESC64_LO20);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_TLS_DESC64_HI12);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_TLS_DESC_LD);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_TLS_DESC_CALL);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_TLS_LE_HI20_R);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_TLS_LE_ADD_R);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_TLS_LE_LO12_R);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_TLS_LD_PCREL20_S2);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_TLS_GD_PCREL20_S2);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_TLS_DESC_PCREL20_S2);
    default:
      return "Unknown";
    }
    break;
