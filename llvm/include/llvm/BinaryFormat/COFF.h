...
enum RelocationTypesLoongArch : unsigned {
  IMAGE_REL_LARCH_NONE = 0,
  IMAGE_REL_LARCH_32 = 1,
  IMAGE_REL_LARCH_64 = 2,
  IMAGE_REL_LARCH_RELATIVE = 3,
  IMAGE_REL_LARCH_COPY = 4,
  IMAGE_REL_LARCH_JUMP_SLOT = 5,
  IMAGE_REL_LARCH_TLS_DTPMOD32 = 6,
  IMAGE_REL_LARCH_TLS_DTPMOD64 = 7,
  IMAGE_REL_LARCH_TLS_DTPREL32 = 8,
  IMAGE_REL_LARCH_TLS_DTPREL64 = 9,
  IMAGE_REL_LARCH_TLS_TPREL32 = 10,
  IMAGE_REL_LARCH_TLS_TPREL64 = 11,
  IMAGE_REL_LARCH_IRELATIVE = 12,
  IMAGE_REL_LARCH_MARK_LA = 20,
  IMAGE_REL_LARCH_MARK_PCREL = 21,
  IMAGE_REL_LARCH_SOP_PUSH_PCREL = 22,
  IMAGE_REL_LARCH_SOP_PUSH_ABSOLUTE = 23,
  IMAGE_REL_LARCH_SOP_PUSH_DUP = 24,
  IMAGE_REL_LARCH_SOP_PUSH_GPREL = 25,
  IMAGE_REL_LARCH_SOP_PUSH_TLS_TPREL = 26,
  IMAGE_REL_LARCH_SOP_PUSH_TLS_GOT = 27,
  IMAGE_REL_LARCH_SOP_PUSH_TLS_GD = 28,
  IMAGE_REL_LARCH_SOP_PUSH_PLT_PCREL = 29,
  IMAGE_REL_LARCH_SOP_ASSERT = 30,
  IMAGE_REL_LARCH_SOP_NOT = 31,
  IMAGE_REL_LARCH_SOP_SUB = 32,
  IMAGE_REL_LARCH_SOP_SL = 33,
  IMAGE_REL_LARCH_SOP_SR = 34,
  IMAGE_REL_LARCH_SOP_ADD = 35,
  IMAGE_REL_LARCH_SOP_AND = 36,
  IMAGE_REL_LARCH_SOP_IF_ELSE = 37,
  IMAGE_REL_LARCH_SOP_POP_32_S_10_5 = 38,
  IMAGE_REL_LARCH_SOP_POP_32_U_10_12 = 39,
  IMAGE_REL_LARCH_SOP_POP_32_S_10_12 = 40,
  IMAGE_REL_LARCH_SOP_POP_32_S_10_16 = 41,
  IMAGE_REL_LARCH_SOP_POP_32_S_10_16_S2 = 42,
  IMAGE_REL_LARCH_SOP_POP_32_S_5_20 = 43,
  IMAGE_REL_LARCH_SOP_POP_32_S_0_5_10_16_S2 = 44,
  IMAGE_REL_LARCH_SOP_POP_32_S_0_10_10_16_S2 = 45,
  IMAGE_REL_LARCH_SOP_POP_32_U = 46,
  IMAGE_REL_LARCH_ADD8 = 47,
  IMAGE_REL_LARCH_ADD16 = 48,
  IMAGE_REL_LARCH_ADD24 = 49,
  IMAGE_REL_LARCH_ADD32 = 50,
  IMAGE_REL_LARCH_ADD64 = 51,
  IMAGE_REL_LARCH_SUB8 = 52,
  IMAGE_REL_LARCH_SUB16 = 53,
  IMAGE_REL_LARCH_SUB24 = 54,
  IMAGE_REL_LARCH_SUB32 = 55,
  IMAGE_REL_LARCH_SUB64 = 56,
  IMAGE_REL_LARCH_GNU_VTINHERIT = 57,
  IMAGE_REL_LARCH_GNU_VTENTRY = 58,
  IMAGE_REL_LARCH_B16 = 64,
  IMAGE_REL_LARCH_B21 = 65,
  IMAGE_REL_LARCH_B26 = 66,
  IMAGE_REL_LARCH_ABS_HI20 = 67,
  IMAGE_REL_LARCH_ABS_LO12 = 68,
  IMAGE_REL_LARCH_ABS64_LO20 = 69,
  IMAGE_REL_LARCH_ABS64_HI12 = 70,
  IMAGE_REL_LARCH_PCALA_HI20 = 71,
  IMAGE_REL_LARCH_PCALA_LO12 = 72,
  IMAGE_REL_LARCH_PCALA64_LO20 = 73,
  IMAGE_REL_LARCH_PCALA64_HI12 = 74,
  IMAGE_REL_LARCH_GOT_PC_HI20 = 75,
  IMAGE_REL_LARCH_GOT_PC_LO12 = 76,
  IMAGE_REL_LARCH_GOT64_PC_LO20 = 77,
  IMAGE_REL_LARCH_GOT64_PC_HI12 = 78,
  IMAGE_REL_LARCH_GOT_HI20 = 79,
  IMAGE_REL_LARCH_GOT_LO12 = 80,
  IMAGE_REL_LARCH_GOT64_LO20 = 81,
  IMAGE_REL_LARCH_GOT64_HI12 = 82,
  IMAGE_REL_LARCH_TLS_LE_HI20 = 83,
  IMAGE_REL_LARCH_TLS_LE_LO12 = 84,
  IMAGE_REL_LARCH_TLS_LE64_LO20 = 85,
  IMAGE_REL_LARCH_TLS_LE64_HI12 = 86,
  IMAGE_REL_LARCH_TLS_IE_PC_HI20 = 87,
  IMAGE_REL_LARCH_TLS_IE_PC_LO12 = 88,
  IMAGE_REL_LARCH_TLS_IE64_PC_LO20 = 89,
  IMAGE_REL_LARCH_TLS_IE64_PC_HI12 = 90,
  IMAGE_REL_LARCH_TLS_IE_HI20 = 91,
  IMAGE_REL_LARCH_TLS_IE_LO12 = 92,
  IMAGE_REL_LARCH_TLS_IE64_LO20 = 93,
  IMAGE_REL_LARCH_TLS_IE64_HI12 = 94,
  IMAGE_REL_LARCH_TLS_LD_PC_HI20 = 95,
  IMAGE_REL_LARCH_TLS_LD_HI20 = 96,
  IMAGE_REL_LARCH_TLS_GD_PC_HI20 = 97,
  IMAGE_REL_LARCH_TLS_GD_HI20 = 98,
  IMAGE_REL_LARCH_32_PCREL = 99,
  IMAGE_REL_LARCH_RELAX = 100,
  IMAGE_REL_LARCH_ALIGN = 102,
  IMAGE_REL_LARCH_PCREL20_S2 = 103,
  IMAGE_REL_LARCH_ADD6 = 105,
  IMAGE_REL_LARCH_SUB6 = 106,
  IMAGE_REL_LARCH_ADD_ULEB128 = 107,
  IMAGE_REL_LARCH_SUB_ULEB128 = 108,
  IMAGE_REL_LARCH_64_PCREL = 109,
  IMAGE_REL_LARCH_CALL36 = 110,
  IMAGE_REL_LARCH_TLS_DESC32 = 13,
  IMAGE_REL_LARCH_TLS_DESC64 = 14,
  IMAGE_REL_LARCH_TLS_DESC_PC_HI20 = 111,
  IMAGE_REL_LARCH_TLS_DESC_PC_LO12 = 112,
  IMAGE_REL_LARCH_TLS_DESC64_PC_LO20 = 113,
  IMAGE_REL_LARCH_TLS_DESC64_PC_HI12 = 114,
  IMAGE_REL_LARCH_TLS_DESC_HI20 = 115,
  IMAGE_REL_LARCH_TLS_DESC_LO12 = 116,
  IMAGE_REL_LARCH_TLS_DESC64_LO20 = 117,
  IMAGE_REL_LARCH_TLS_DESC64_HI12 = 118,
  IMAGE_REL_LARCH_TLS_DESC_LD = 119,
  IMAGE_REL_LARCH_TLS_DESC_CALL = 120,
  IMAGE_REL_LARCH_TLS_LE_HI20_R = 121,
  IMAGE_REL_LARCH_TLS_LE_ADD_R = 122,
  IMAGE_REL_LARCH_TLS_LE_LO12_R = 123,
  IMAGE_REL_LARCH_TLS_LD_PCREL20_S2 = 124,
  IMAGE_REL_LARCH_TLS_GD_PCREL20_S2 = 125,
  IMAGE_REL_LARCH_TLS_DESC_PCREL20_S2 = 126,
};
