...
; RUN: llc --mtriple=loongarch32 --mattr=+d,-la32s --relocation-model=static < %s | FileCheck %s --check-prefixes=ALL,LA32RNOPIC
; RUN: llc --mtriple=loongarch32 --mattr=+d,+la32s --relocation-model=static < %s | FileCheck %s --check-prefixes=ALL,LA32SNOPIC
; RUN: llc --mtriple=loongarch32 --mattr=+d,-la32s --relocation-model=pic < %s | FileCheck %s --check-prefixes=ALL,LA32RPIC
; RUN: llc --mtriple=loongarch32 --mattr=+d,+la32s --relocation-model=pic < %s | FileCheck %s --check-prefixes=ALL,LA32SPIC
