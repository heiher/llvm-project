...
; LA64-NEXT:    xvinsgr2vr.d $xr1, $a0, 0
; LA64-NEXT:    xvpickve2gr.d $a0, $xr0, 1
; LA64-NEXT:    bitrev.8b $a0, $a0
; LA64-NEXT:    xvinsgr2vr.d $xr1, $a0, 1
; LA64-NEXT:    xvpickve2gr.d $a0, $xr0, 2
; LA64-NEXT:    bitrev.8b $a0, $a0
; LA64-NEXT:    xvinsgr2vr.d $xr1, $a0, 2
; LA64-NEXT:    xvpickve2gr.d $a0, $xr0, 3
; LA64-NEXT:    bitrev.8b $a0, $a0
; LA64-NEXT:    xvinsgr2vr.d $xr1, $a0, 3
...
; LA64-NEXT:    bitrev.d $a0, $a0
; LA64-NEXT:    xvinsgr2vr.d $xr1, $a0, 3
; LA64-NEXT:    xvshuf4i.h $xr0, $xr1, 27
; LA64-NEXT:    ret
...
; LA64-NEXT:    bitrev.d $a0, $a0
; LA64-NEXT:    xvinsgr2vr.d $xr1, $a0, 3
; LA64-NEXT:    xvshuf4i.w $xr0, $xr1, 177
; LA64-NEXT:    ret
