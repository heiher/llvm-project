...
; RUN: llc --mtriple=loongarch32 --mattr=+f,-d,+la32s < %s | FileCheck %s --check-prefix=LA32F
; RUN: llc --mtriple=loongarch32 --mattr=+d,+la32s < %s | FileCheck %s --check-prefix=LA32D
