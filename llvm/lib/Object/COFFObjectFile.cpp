...
StringRef COFFObjectFile::getRelocationTypeName(uint16_t Type) const {
  ...
  case Triple::loongarch64:
    switch (Type) {
      ...
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_CALL30);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_CALL36);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_PCREL20_S2);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_PCADD_HI20);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_LARCH_PCADD_LO12);
