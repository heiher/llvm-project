...
; RUN: llc --mtriple=loongarch32 -mattr=+d,-la32s --verify-machineinstrs < %s | FileCheck %s --check-prefix=LA32R
; RUN: llc --mtriple=loongarch32 -mattr=+d,+la32s --verify-machineinstrs < %s | FileCheck %s --check-prefix=LA32S
...
; LA32S-NEXT:  # %bb.3:
; LA32S-NEXT:  .Lpcadd_hi0:
; LA32S-NEXT:    pcaddu12i $a0, %pcadd_hi20(.LBB2_2)
; LA32S-NEXT:    addi.w $a0, $a0, %pcadd_lo12(.Lpcadd_hi0)
; LA32S-NEXT:    jr $a0
