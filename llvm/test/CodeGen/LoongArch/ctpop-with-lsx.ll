...
; RUN: llc --mtriple=loongarch32 -mattr=+lsx,-la32s < %s | FileCheck %s --check-prefix=LA32R
; RUN: llc --mtriple=loongarch32 -mattr=+lsx,+la32s < %s | FileCheck %s --check-prefix=LA32S
