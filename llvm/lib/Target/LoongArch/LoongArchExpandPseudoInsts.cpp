...
bool LoongArchPreRAExpandPseudo::expandPcaxxu12iInstPair(
  ...
  if (OpcodeHi == LoongArch::PCADDU12I) {
...
bool LoongArchPreRAExpandPseudo::expandLoadAddressPcrel(
  ...
  const auto &STI = MF->getSubtarget<LoongArchSubtarget>();
  unsigned OpcodeHi =
      STI.is64Bit() ? LoongArch::PCALAU12I : LoongArch::PCADDU12I;
  unsigned OpcodeLo = STI.is64Bit() ? LoongArch::ADDI_D : LoongArch::ADDI_W;
  unsigned FlagsHi =
      STI.is64Bit() ? LoongArchII::MO_PCREL_HI : LoongArchII::MO_PCADD_HI;
  unsigned FlagsLo =
      STI.is64Bit() ? LoongArchII::MO_PCREL_LO : LoongArchII::MO_PCADD_LO;
...
bool LoongArchPreRAExpandPseudo::expandLoadAddressGot(
  ...
  unsigned FlagsHi =
      STI.is64Bit() ? LoongArchII::MO_GOT_PC_HI : LoongArchII::MO_PCADD_GOT_HI;
  unsigned FlagsLo =
      STI.is64Bit() ? LoongArchII::MO_GOT_PC_LO : LoongArchII::MO_PCADD_LO;
  return expandPcaxxu12iInstPair(MBB, MBBI, NextMBBI, OpcodeHi, OpcodeLo,
                                 FlagsHi, FlagsLo);
}
...
bool LoongArchPreRAExpandPseudo::expandLoadAddressTLSIE(
  ...
  unsigned OpcodeLo = STI.is64Bit() ? LoongArch::LD_D : LoongArch::LD_W;
  unsigned FlagsHi =
      STI.is64Bit() ? LoongArchII::MO_IE_PC_HI : LoongArchII::MO_PCADD_IE_HI;
  unsigned FlagsLo =
      STI.is64Bit() ? LoongArchII::MO_IE_PC_LO : LoongArchII::MO_PCADD_LO;
  return expandPcaxxu12iInstPair(MBB, MBBI, NextMBBI, OpcodeHi, OpcodeLo,
                                 FlagsHi, FlagsLo);
}
...
bool LoongArchPreRAExpandPseudo::expandLoadAddressTLSDesc(
  ...
  const auto &STI = MF->getSubtarget<LoongArchSubtarget>();
  unsigned PCA = STI.is64Bit() ? LoongArch::PCALAU12I : LoongArch::PCADDU12I;
...
bool LoongArchExpandPseudo::expandFunctionCALL(
  ...
  case CodeModel::Medium: {
    ...
    //   jirl      $r0, $t8, 0
    IsArch64Bit = MF->getTarget().getTargetTriple().isArch64Bit();
    Opcode =
        IsTailCall ? LoongArch::PseudoJIRL_TAIL : LoongArch::PseudoJIRL_CALL;
    Register ScratchReg = IsTailCall ? LoongArch::R20 : LoongArch::R1;
    MachineInstrBuilder MIB = BuildMI(
        MBB, MBBI, DL,
        TII->get(IsArch64Bit ? LoongArch::PCADDU18I : LoongArch::PCADDU12I),
        ScratchReg);
    ...
    if (Func.isSymbol())
      MIB.addExternalSymbol(Func.getSymbolName(), IsArch64Bit
                                                      ? LoongArchII::MO_CALL36
                                                      : LoongArchII::MO_CALL30);
    else
      MIB.addDisp(Func, 0,
                  IsArch64Bit ? LoongArchII::MO_CALL36
                              : LoongArchII::MO_CALL30);
    break;
  }
  }
