...
; LA32-NEXT:    # kill: def $f0 killed $f0 def $xr0
; LA32-NEXT:    xvld $xr1, $sp, 48 # 32-byte Folded Reload
; LA32-NEXT:    xvinsve0.w $xr1, $xr0, 3
; LA32-NEXT:    xvst $xr1, $sp, 48 # 32-byte Folded Spill
; LA32-NEXT:    xvld $xr0, $sp, 16 # 32-byte Folded Reload
...
; LA32-NEXT:    # kill: def $f0 killed $f0 def $xr0
; LA32-NEXT:    xvld $xr1, $sp, 48 # 32-byte Folded Reload
; LA32-NEXT:    xvinsve0.w $xr1, $xr0, 7
...
; LA64-NEXT:    xvinsve0.w $xr0, $xr1, 1
; LA64-NEXT:    xvst $xr0, $sp, 48 # 32-byte Folded Spill
; LA64-NEXT:    xvld $xr0, $sp, 16 # 32-byte Folded Reload
...
; LA64-NEXT:    # kill: def $f0 killed $f0 def $xr0
; LA64-NEXT:    xvld $xr1, $sp, 48 # 32-byte Folded Reload
; LA64-NEXT:    xvinsve0.w $xr1, $xr0, 2
...
; LA64-NEXT:    # kill: def $f0 killed $f0 def $xr0
; LA64-NEXT:    xvld $xr1, $sp, 48 # 32-byte Folded Reload
; LA64-NEXT:    xvinsve0.w $xr1, $xr0, 3
; LA64-NEXT:    xvst $xr1, $sp, 48 # 32-byte Folded Spill
; LA64-NEXT:    xvld $xr0, $sp, 16 # 32-byte Folded Reload
...
; LA64-NEXT:    # kill: def $f0 killed $f0 def $xr0
; LA64-NEXT:    xvld $xr1, $sp, 48 # 32-byte Folded Reload
; LA64-NEXT:    xvinsve0.w $xr1, $xr0, 4
; LA64-NEXT:    xvst $xr1, $sp, 48 # 32-byte Folded Spill
; LA64-NEXT:    xvld $xr0, $sp, 16 # 32-byte Folded Reload
...
; LA64-NEXT:    # kill: def $f0 killed $f0 def $xr0
; LA64-NEXT:    xvld $xr1, $sp, 48 # 32-byte Folded Reload
; LA64-NEXT:    xvinsve0.w $xr1, $xr0, 5
; LA64-NEXT:    xvst $xr1, $sp, 48 # 32-byte Folded Spill
; LA64-NEXT:    xvld $xr0, $sp, 16 # 32-byte Folded Reload
...
; LA64-NEXT:    # kill: def $f0 killed $f0 def $xr0
; LA64-NEXT:    xvld $xr1, $sp, 48 # 32-byte Folded Reload
; LA64-NEXT:    xvinsve0.w $xr1, $xr0, 6
; LA64-NEXT:    xvst $xr1, $sp, 48 # 32-byte Folded Spill
; LA64-NEXT:    xvld $xr0, $sp, 16 # 32-byte Folded Reload
...
; LA64-NEXT:    # kill: def $f0 killed $f0 def $xr0
; LA64-NEXT:    xvld $xr1, $sp, 48 # 32-byte Folded Reload
; LA64-NEXT:    xvinsve0.w $xr1, $xr0, 7
...
; LA32-NEXT:    # kill: def $f0_64 killed $f0_64 def $xr0
; LA32-NEXT:    xvld $xr1, $sp, 16 # 32-byte Folded Reload
; LA32-NEXT:    xvinsve0.d $xr1, $xr0, 2
...
; LA32-NEXT:    # kill: def $f0_64 killed $f0_64 def $xr0
; LA32-NEXT:    xvld $xr1, $sp, 16 # 32-byte Folded Reload
; LA32-NEXT:    xvinsve0.d $xr1, $xr0, 3
; LA32-NEXT:    xvori.b $xr0, $xr1, 0
; LA32-NEXT:    ld.w $fp, $sp, 88 # 4-byte Folded Reload
; LA32-NEXT:    ld.w $ra, $sp, 92 # 4-byte Folded Reload
; LA32-NEXT:    addi.w $sp, $sp, 96
...
; LA64-NEXT:    # kill: def $f0_64 killed $f0_64 def $xr0
; LA64-NEXT:    xvld $xr1, $sp, 16 # 32-byte Folded Reload
; LA64-NEXT:    xvinsve0.d $xr1, $xr0, 2
...
; LA64-NEXT:    # kill: def $f0_64 killed $f0_64 def $xr0
; LA64-NEXT:    xvld $xr1, $sp, 16 # 32-byte Folded Reload
; LA64-NEXT:    xvinsve0.d $xr1, $xr0, 3
; LA64-NEXT:    xvori.b $xr0, $xr1, 0
; LA64-NEXT:    ld.d $fp, $sp, 80 # 8-byte Folded Reload
; LA64-NEXT:    ld.d $ra, $sp, 88 # 8-byte Folded Reload
; LA64-NEXT:    addi.d $sp, $sp, 96
